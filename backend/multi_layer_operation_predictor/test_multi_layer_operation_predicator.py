...
from operation_predictor import (MatchMethod, clean_function_name, preprocess_text, load_functions, find_closest_operation_fuzzy, find_closest_operation_substring, train_ml_model, load_ml_model, predict_operation_name_ml, get_operation_definition)
...
class TestOperationFunctions(unittest.TestCase):
    ...
    @patch('operation_predictor.load_functions', return_value=MOCKED_OPERATIONS)
    @patch('operation_predictor.find_closest_operation_substring', return_value=("operation1", MatchMethod.SUBSTRING))
    @patch('operation_predictor.find_closest_operation_fuzzy', return_value=("operation2", MatchMethod.FUZZY))
    @patch('operation_predictor.predict_operation_name_ml', return_value=("operation3", MatchMethod.ML))
    ...
    @patch('operation_predictor.load_functions',return_value=MOCKED_OPERATIONS)
    @patch('operation_predictor.load_ml_model')
    @patch('operation_predictor.find_closest_operation_substring')
    @patch('operation_predictor.find_closest_operation_fuzzy')
